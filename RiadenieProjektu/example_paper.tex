...
%  - sp   - Seminar paper
\documentclass[rp, m]{FEIstyle}
% \documentclass[sp, m, en]{FEIstyle} % If you want to write the thesis in English, add the argument `en`

\FEIauthor{Bc. Eduard Zelenay Bc. Erik Móčik Bc. Filip Lobpreis Bc. Jakub Močarník Bc. Maroš Kocúr Bc. Matúš Machata Bc. Timotej Polc}
\FEItitle{Micro mouse}
\FEItitleEn{Micro mouse}
\FEIcourse{Tímový projekt }
\FEIcourseEn{Team project}
\FEIcourseTag{I--TP}
\FEIlecturer{doc. Ing. Andrej Babinec, PhD.}
% \FEITA{Ing. Marián Tárník, PhD.}
